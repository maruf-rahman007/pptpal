  ...
  return (
    <div className="pt-20 bg-customColor2">
      ...
      <div className="flex flex-row justify-center pt-7 gap-4">
        <Button className="bg-customfontColor hover:bg-customColor2 text-neutral-800 text-2xl px-3 py-5 rounded-xl" variant="outline" onClick={()=>{
          route.push("/usersignin")
        }}>Get Started</Button>
        <Button className="text-2xl px-6 py-5 hover:bg-slate-300 rounded-xl" variant="outline" onClick={()=>{
          route.push("/roomsignin")
        }}>Login To Room</Button>
      </div>
